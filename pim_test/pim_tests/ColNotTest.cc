...
class colReadVerifyNot : public ColumnOperation {
  private:
    void* addr2; // for debug
  public :
    colReadVerifyNot(void* _addr2) :
    addr2(_addr2) {};
...
int main(){
    ...
    *(uint8_t*)addr2 = 0x11;
    ...
    colReadVerifyNot* fcolReadVerifyNot =
            new colReadVerifyNot(addr2);
