...
class colReadVerifyLt : public ColumnOperation {
  private:
    void* addr2; // for debug
  public :
    colReadVerifyLt(void* _addr2) :
    addr2(_addr2) {};
...
int main(){
    ...
    *(uint8_t*)addr2 = 0x11;
    ...
    colReadVerifyLt* fcolReadVerifyLt =
            new colReadVerifyLt(addr2);
